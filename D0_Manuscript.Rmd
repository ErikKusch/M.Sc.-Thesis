...
Long <- paste("Coefficients of linear regressions of Qsoil", SoilLayer, " memory coefficients against PFT data 
              ...
              and extended maps of species-specific trait means (M).", sep="")
kab <- kable(tabout, 
            booktabs = TRUE,
...
Long <- paste("Linear regression coefficients of COMPADRE data and vegetation memory coefficients.", sep="")
kab <- kable(tabout, 
            booktabs = TRUE,
            caption = paste("\\textbf{",Short, " -} ",Long, sep=""),
            caption.short = Short,
...
Long <- paste("Coefficients of linear regressions of vegetation sensitivity across the Iberian Region.", sep="")
kab <- kable(tabout, 
            booktabs = TRUE,
            caption = paste("\\textbf{",Short, " -} ",Long, sep=""),
            caption.short = Short,
...
Long <- paste("Linear regression coefficients of vegetative height (H) and leaf nitrogen mass (Nmass) against 
              vegetation memory coefficients.", sep="")
kab <- kable(tabout, 
            booktabs = TRUE,
            caption = paste("\\textbf{",Short, " -} ",Long, sep=""),
            caption.short = Short,
...
### Explaining Functional Causes of Vegetation Memory
...
table \ref{tab:IBRU1} (established via \ref{rUresChunk})
figure \ref{fig:IBRVegMem1}
figure \ref{fig:IBRVarPar1}

\clearpage

```{r IBRVegMem1, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 't-1', 'Qsoil', 'Tair'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Iberian Region; Qsoil1) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. Figure established via \\ref{rModelRes}. \\label{fig:IBRVegMem1}", fig.scap="Vegetation Memory Coefficients (Iberian Region; Qsoil1)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
table \ref{tab:IBRU2} (established via \ref{rUresChunk})
figure \ref{fig:IBRVegMem2}
figure \ref{fig:IBRVarPar2}

```{r IBRVegMem2, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Iberian Region; Qsoil2) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. Figure established via \\ref{rModelRes}. \\label{fig:IBRVegMem2}", fig.scap="Vegetation Memory Coefficients (Iberian Region; Qsoil2)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVarPar2, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Iberian Region; Qsoil2) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:IBRVarPar2}", fig.scap="Variance Partitioning (Iberian Region; Qsoil2)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVarPar3, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Iberian Region; Qsoil3) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:IBRVarPar3}", fig.scap="Variance Partitioning (Iberian Region; Qsoil3)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
table \ref{tab:IBRU4} (established via \ref{rUresChunk})
figure \ref{fig:IBRVegMem4}
figure \ref{fig:IBRVarPar4}

```{r IBRVegMem4, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Iberian Region; Qsoil4) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. Figure established via \\ref{rModelRes}. \\label{fig:IBRVegMem4}", fig.scap="Vegetation Memory Coefficients (Iberian Region; Qsoil4)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVarPar4, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Iberian Region; Qsoil4) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:IBRVarPar4}", fig.scap="Variance Partitioning (Iberian Region; Qsoil4)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
Memory ANOVA - $p = `r IBANOVA[[1]][1,5]`$  (established via \ref{rPatCausAnova})
Qsoil ANOVA - $p = `r IBANOVA[[2]][1,5]`$ (established via \ref{rPatCausAnova})
...
table \ref{tab:IBCOMPADTab1} (established via \ref{rCOMPADTab})

figure \ref{fig:IBCOMPAD2}
table \ref{tab:IBCOMPADTab2} (established via \ref{rCOMPADTab})
...
table \ref{tab:IBCOMPADTab3} (established via \ref{rCOMPADTab})
...
table \ref{tab:IBCOMPADTab4} (established via \ref{rCOMPADTab})
...
table \ref{tab:IBCOMPADTab5} (established via \ref{rCOMPADTab})
...
table \ref{tab:IBPFTTab3} (established via \ref{rTRYresTab})
...
table \ref{tab:IBPFTTab4} (established via \ref{rTRYresTab})
...
table \ref{tab:IBPFTTab5} (established via \ref{rTRYresTab})
...
table \ref{tab:IBPFTTab6} (established via \ref{rTRYresTab})
...
\paragraph*{Summary}  \hspace{.5cm}
table \ref{tab:IBPFTTabRaw} (established via \ref{rPFTTab})
table \ref{tab:IBPFTTabMapped} (established via \ref{rPFTTab})
...
table \ref{tab:CAU1} (established via \ref{rUresChunk})
figure \ref{fig:CAVegMem1}
figure \ref{fig:CAVarPar1}

\clearpage

```{r CAVegMem1, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 't-1', 'Qsoil', 'Tair'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Caatinga; Qsoil1) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. Figure established via \\ref{rModelRes}. \\label{fig:CAVegMem1}", fig.scap="Vegetation Memory Coefficients (Caatinga; Qsoil1)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r CAVarPar1, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Caatinga; Qsoil1) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:CAVarPar1}", fig.scap="Variance Partitioning (Caatinga; Qsoil1)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
VarParRes(Region = "Caatinga", SoilLayer = 1)
```
...
table \ref{tab:CAU2} (established via \ref{rUresChunk})
figure \ref{fig:CAVegMem2}
figure \ref{fig:CAVarPar2}

```{r CAVegMem2, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Caatinga; Qsoil2) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. Figure established via \\ref{rModelRes}. \\label{fig:CAVegMem2}", fig.scap="Vegetation Memory Coefficients (Caatinga; Qsoil2)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r CAVarPar2, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Caatinga; Qsoil2) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:CAVarPar2}", fig.scap="Variance Partitioning (Caatinga; Qsoil2)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
VarParRes(Region = "Caatinga", SoilLayer = 2)
```
...
```{r CAVarPar3, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Caatinga; Qsoil3) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:CAVarPar3}", fig.scap="Variance Partitioning (Caatinga; Qsoil3)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
VarParRes(Region = "Caatinga", SoilLayer = 3)
```
...
table \ref{tab:CAU4} (established via \ref{rUresChunk})
figure \ref{fig:CAVegMem4}
figure \ref{fig:CAVarPar4}

```{r CAVegMem4, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Caatinga; Qsoil4) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. Figure established via \\ref{rModelRes}. \\label{fig:CAVegMem4}", fig.scap="Vegetation Memory Coefficients (Caatinga; Qsoil4)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r CAVarPar4, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Caatinga; Qsoil4) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:CAVarPar4}", fig.scap="Variance Partitioning (Caatinga; Qsoil4)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
VarParRes(Region = "Caatinga", SoilLayer = 4)
```
...
table \ref{tab:CAQsoilU} (established via \ref{rUQsoilRes})
figure \ref{fig:CALayers}

```{r CALayers, echo = FALSE, fig.width = 17, fig.height = 12, fig.subcap=c('Qsoil1', 'Qsoil2', 'Qsoil3', 'Qsoil4'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Caatinga, QSoil Layers) -} Vegetation memory coefficients of different \\qsoil layers. These are also contained in figures \\ref{fig:CAVegMem1}, \\ref{fig:CAVegMem2}, \\ref{fig:CAVegMem3}, and \\ref{fig:CAVegMem4} and have been scaled to be represented on the same colour axis for comparability. Figure established via \\ref{rSoilLayersRes}. \\label{fig:CALayers}", fig.scap="Vegetation Memory Coefficients (Caatinga, QSoil Layers)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
Memory ANOVA - $p = `r CAANOVA[[1]][1,5]`$  (established via \ref{rPatCausAnova})
Qsoil ANOVA - $p = `r CAANOVA[[2]][1,5]`$ (established via \ref{rPatCausAnova})
...
table \ref{tab:CACOMPADTab1} (established via \ref{rCOMPADTab})

figure \ref{fig:CACOMPAD2}
table \ref{tab:CACOMPADTab2} (established via \ref{rCOMPADTab})
...
table \ref{tab:CACOMPADTab3} (established via \ref{rCOMPADTab})
...
table \ref{tab:CACOMPADTab4} (established via \ref{rCOMPADTab})
...
table \ref{tab:CACOMPADTab5} (established via \ref{rCOMPADTab})
...
table \ref{tab:CAPFTTab3} (established via \ref{rTRYresTab})
...
table \ref{tab:CAPFTTab4} (established via \ref{rTRYresTab})
...
table \ref{tab:CAPFTTab5} (established via \ref{rTRYresTab})
...
table \ref{tab:CAPFTTab6} (established via \ref{rTRYresTab})
...
\paragraph*{Summary}  \hspace{.5cm}
table \ref{tab:CAPFTTabRaw} (established via \ref{rPFTTab})
table \ref{tab:CAPFTTabMapped} (established via \ref{rPFTTab})
...
table \ref{tab:AUU1} (established via \ref{rUresChunk})
figure \ref{fig:AUVegMem1}
figure \ref{fig:AUVarPar1}

\clearpage

```{r AUVegMem1, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 't-1', 'Qsoil', 'Tair'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Australia; Qsoil1) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. Figure established via \\ref{rModelRes}. \\label{fig:AUVegMem1}", fig.scap="Vegetation Memory Coefficients (Australia; Qsoil1)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r AUVarPar1, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Australia; Qsoil1) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:AUVarPar1}", fig.scap="Variance Partitioning (Australia; Qsoil1)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
VarParRes(Region = "Australia", SoilLayer = 1)
```
...
table \ref{tab:AUU2} (established via \ref{rUresChunk})
figure \ref{fig:AUVegMem2}
figure \ref{fig:AUVarPar2}

```{r AUVegMem2, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Australia; Qsoil2) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. Figure established via \\ref{rModelRes}. \\label{fig:AUVegMem2}", fig.scap="Vegetation Memory Coefficients (Australia; Qsoil2)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r AUVarPar2, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Australia; Qsoil2) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:AUVarPar2}", fig.scap="Variance Partitioning (Australia; Qsoil2)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
VarParRes(Region = "Australia", SoilLayer = 2)
```
...
```{r AUVarPar3, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Australia; Qsoil3) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:AUVarPar3}", fig.scap="Variance Partitioning (Australia; Qsoil3)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
VarParRes(Region = "Australia", SoilLayer = 3)
```
...
table \ref{tab:AUU4} (established via \ref{rUresChunk})
figure \ref{fig:AUVegMem4}
figure \ref{fig:AUVarPar4}

```{r AUVegMem4, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Australia; Qsoil4) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. Figure established via \\ref{rModelRes}. \\label{fig:AUVegMem4}", fig.scap="Vegetation Memory Coefficients (Australia; Qsoil4)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r AUVarPar4, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Australia; Qsoil4) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. Figure established via \\ref{rVarParRes}. \\label{fig:AUVarPar4}", fig.scap="Variance Partitioning (Australia; Qsoil4)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
VarParRes(Region = "Australia", SoilLayer = 4)
```
...
table \ref{tab:AUQsoilU} (established via \ref{rUQsoilRes})
figure \ref{fig:AULayers}

```{r AULayers, echo = FALSE, fig.width = 17, fig.height = 12, fig.subcap=c('Qsoil1', 'Qsoil2', 'Qsoil3', 'Qsoil4'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Australia, QSoil Layers) -} Vegetation memory coefficients of different \\qsoil layers. These are also contained in figures \\ref{fig:AUVegMem1}, \\ref{fig:AUVegMem2}, \\ref{fig:AUVegMem3}, and \\ref{fig:AUVegMem4} and have been scaled to be represented on the same colour axis for comparability. Figure established via \\ref{rSoilLayersRes}. \\label{fig:AULayers}", fig.scap="Vegetation Memory Coefficients (Australia, QSoil Layers)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
Memory ANOVA - $p = `r AUANOVA[[1]][1,5]`$  (established via \ref{rPatCausAnova})
Qsoil ANOVA - $p = `r AUANOVA[[2]][1,5]`$ (established via \ref{rPatCausAnova})
...
table \ref{tab:AUCOMPADTab1} (established via \ref{rCOMPADTab})

figure \ref{fig:AUCOMPAD2}
table \ref{tab:AUCOMPADTab2} (established via \ref{rCOMPADTab})
...
table \ref{tab:AUCOMPADTab3} (established via \ref{rCOMPADTab})
...
table \ref{tab:AUCOMPADTab4} (established via \ref{rCOMPADTab})
...
table \ref{tab:AUCOMPADTab5} (established via \ref{rCOMPADTab})
...
table \ref{tab:AUPFTTab3} (established via \ref{rTRYresTab})
...
table \ref{tab:AUPFTTab4} (established via \ref{rTRYresTab})
...
table \ref{tab:AUPFTTab5} (established via \ref{rTRYresTab})
...
table \ref{tab:AUPFTTab6} (established via \ref{rTRYresTab})
...
\paragraph*{Summary}  \hspace{.5cm}
table \ref{tab:AUPFTTabRaw} (established via \ref{rPFTTab})
table \ref{tab:AUPFTTabMapped} (established via \ref{rPFTTab})
