...
<!-- Since vegetation memory is largely researched in terms of water limitations and precipitation events, dryland regions (as classified via ombrotypes within Rivas-Martínez et al.\cite{Rivas-Martinez2011}) are expected to allow for identification of extrinsic memory effects.  Since strong memoryindicates low resilience, AR1 -->
