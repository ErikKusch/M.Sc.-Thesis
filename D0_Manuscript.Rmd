...
Output <- PatcausRes(Region = "Iberian Region", SoilLayer = 1, SoilOnly = FALSE)
```

\ndvi - $Intercept = `r Output[[1]]`$ ($p = `r Output[[2]]`$); $r = `r Output[[3]]`$ ($p = `r Output[[4]]`$)
...
Output <- PatcausRes(Region = "Iberian Region", SoilLayer = 1, SoilOnly = TRUE)
```

Memory Length - $Intercept = `r Output[[1]]`$ ($p = `r Output[[2]]`$); $r = `r Output[[3]]`$ ($p = `r Output[[4]]`$)
...
Output <- PatcausRes(Region = "Iberian Region", SoilLayer = 2, SoilOnly = TRUE)
```
...
Output <- PatcausRes(Region = "Iberian Region", SoilLayer = 3, SoilOnly = TRUE)
```
...
Output <- PatcausRes(Region = "Iberian Region", SoilLayer = 4, SoilOnly = TRUE)
```
