...
PatcausRes <- function(Region, SoilLayer, SoilOnly){
  ...
  geom_boxplot() + theme_bw(base_size = 35) + ylab(paste("Mean Soil Moisture", QsoilTitle[SoilLayer])) + xlab(paste("Soil Moisture", QsoilTitle[SoilLayer], "Memory Length")) + coord_flip()
print(plotm)
...
Long <- paste("Coefficients of linear regressions of Qsoil", SoilLayer, " memory coefficients against PFT data (vegetative height H, and leaf nitrogen mass Nmass) both as raw geo-referenced data (R), and extended maps of species-specific trait means (M).", sep="")
kab <- kable(tabout, 
            booktabs = TRUE,
...
kab <- add_header_above(kable_input = kab, header = c(" " = 1, "Qsoil" = 4, "Memory" = 4), bold = TRUE, align = 'c')
...
Long <- paste("Rownames represent median values of vegetation memory coefficients contained in column names. U-Test statistics of vegetation memory coefficient values are contained within the upper-righthand cells. $p$-values belonging to these $U$-values are represented in the lower-lefthand block of cells.")
kab <- kable(Utab, 
            booktabs = TRUE,
            caption = paste("\\textbf{",Short, " -} ",Long, sep=""),
            caption.short = Short,
...
Long <- paste("Rownames represent median values of Qsoil vegetation memory coefficients contained in column names. U-Test statistics of vegetation memory coefficient values are contained within the upper-righthand cells. $p$-values belonging to these $U$-values are represented in the lower-lefthand block of cells.")
kab <- kable(Utab, 
            booktabs = TRUE,
            caption = paste("\\textbf{",Short, " -} ",Long, sep=""),
            caption.short = Short,
...
kab <- kable(tabout, 
            ...
            escape = FALSE,
            format = 'latex')
kab <- add_header_above(kable_input = kab, header = c(" " = 3, "Qsoil" = 4, "Memory Length" = 4), bold = TRUE, align = 'c')
kab <- kable_styling(kab, latex_options = c("hold_position"))
print(kab)
}
```
...
```{r IBRVegMem1, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 't-1', 'Qsoil', 'Tair'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Iberian Redion; Qsoil1) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. \\label{fig:IBRVegMem1}", fig.scap="Vegetation Memory Coefficients (Iberian Redion; Qsoil1)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVarPar1, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Iberian Redion; Qsoil1) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. \\label{fig:IBRVarPar1}", fig.scap="Variance Partitioning (Iberian Redion; Qsoil1)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVegMem2, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Iberian Redion; Qsoil2) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. \\label{fig:IBRVegMem2}", fig.scap="Vegetation Memory Coefficients (Iberian Redion; Qsoil2)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVarPar2, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Iberian Redion; Qsoil2) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. \\label{fig:IBRVarPar2}", fig.scap="Variance Partitioning (Iberian Redion; Qsoil2)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVegMem3, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Iberian Redion; Qsoil3) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. \\label{fig:IBRVegMem3}", fig.scap="Vegetation Memory Coefficients (Iberian Redion; Qsoil3)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVarPar3, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Iberian Redion; Qsoil3) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. \\label{fig:IBRVarPar3}", fig.scap="Variance Partitioning (Iberian Redion; Qsoil3)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVegMem4, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('SoilLag', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Coefficients (Iberian Redion; Qsoil4) -} Coefficients of vegetation memory obtained via model selection (figure \\ref{fig:ModScheme}) and \\pca regression (figure \\ref{fig:PCAREG}). For an interpretation of these coefficients, see table \\ref{tab:CoeffsOverview}. \\label{fig:IBRVegMem4}", fig.scap="Vegetation Memory Coefficients (Iberian Redion; Qsoil4)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBRVarPar4, echo = FALSE, fig.width = 17, fig.height = 14, fig.subcap=c('Total', 't-1', 'Shared', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Variance Partitioning (Iberian Redion; Qsoil4) -} Variance of \\ndvi anomalies explained by (a) full models of intrinsic and extrinsic memory, (b) intrinsic memory, (c) shared variance, and (d) extrinsic memory. A representation of how these were calculated can be retrieved in figure \\ref{fig:VarPar}. \\label{fig:IBRVarPar4}", fig.scap="Variance Partitioning (Iberian Redion; Qsoil4)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBPatCausRes1, echo = FALSE, fig.width = 17, fig.height = 12, fig.subcap=c('Memory Length', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Sensitivity (Qsoil1, Iberian Region) -} \\qsoila vegetation memory coefficients and \\qsoila memory length of figure \\ref{fig:IBRVegMem1} plotted against mean \\qsoila records (see figure \\ref{fig:IBPDataOverview}). \\label{fig:IBPatCausRes1}", fig.scap="Vegetation Memory Sensitivity (Qsoil1, Iberian Region)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBPatCausRes2, echo = FALSE, fig.width = 17, fig.height = 12, fig.subcap=c('Memory Length', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Sensitivity (Qsoil2, Iberian Region) -} \\qsoilb vegetation memory coefficients and \\qsoilb memory length of figure \\ref{fig:IBRVegMem2} plotted against mean \\qsoilb records (see figure \\ref{fig:IBPDataOverview}). \\label{fig:IBPatCausRes2}", fig.scap="Vegetation Memory Sensitivity (Qsoil2, Iberian Region)", ache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBPatCausRes3, echo = FALSE, fig.width = 17, fig.height = 12, fig.subcap=c('Memory Length', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Sensitivity (Qsoil3, Iberian Region) -} \\qsoilc vegetation memory coefficients and \\qsoilc memory length of figure \\ref{fig:IBRVegMem3} plotted against mean \\qsoilc records (see figure \\ref{fig:IBPDataOverview}). \\label{fig:IBPatCausRes3}", fig.scap="Vegetation Memory Sensitivity (Qsoil3, Iberian Region)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
```{r IBPatCausRes4, echo = FALSE, fig.width = 17, fig.height = 12, fig.subcap=c('Memory Length', 'Qsoil'), fig.ncol = 2, out.width='.5\\linewidth', fig.cap="\\textbf{Vegetation Memory Sensitivity (Qsoil4, Iberian Region) -} \\qsoild vegetation memory coefficients and \\qsoild memory length of figure \\ref{fig:IBRVegMem4} plotted against mean \\qsoila records (see figure \\ref{fig:IBPDataOverview}). \\label{fig:IBPatCausRes4}", fig.scap="Vegetation Memory Sensitivity (Qsoil4, Iberian Region)", cache = TRUE, cache.lazy=FALSE, fig.pos = 'h!'}
...
table \ref{tab:IBPatCauseTab}

```{r IBPatCauseTab, results = 'asis', echo = FALSE}
ModelCoeffs <- c(IBPatCauseRes, IBPatCauseRes1, IBPatCauseRes2, IBPatCauseRes3, IBPatCauseRes4)
ModelCoeffs <- unlist(ModelCoeffs)
tabout <- data.frame(Column = ModelCoeffs[1:4])
starts <- seq(1,length(ModelCoeffs), by = 4)
for(i in 2:(length(ModelCoeffs)/4)){
...
rownames(tabout) <- c("Intercept", "$p_{Intercept}$", "Slope", "$p_{Slope}$")
Short <- paste("Vegetation Memory Sensitivity (Iberian Region)", sep="")
...
kab <- kable(tabout, 
            ...
            escape = FALSE,
            format = 'latex')
kab <- add_header_above(kable_input = kab, header = c(" " = 3, "Qsoil" = 4, "Memory" = 4), bold = TRUE, align = 'c')
kab <- kable_styling(kab, latex_options = c("hold_position"))
print(kab)
```
...
ModelCoeffs <- c(unlist(IBPFT1)[c(1:4, 9:12)], unlist(IBPFT2)[c(1:4, 9:12)], 
                 unlist(IBPFT3)[c(1:4, 9:12)], unlist(IBPFT4)[c(1:4, 9:12)], 
                 unlist(IBPFT5)[c(1:4, 9:12)], unlist(IBPFT6)[c(1:4, 9:12)])
tabout <- data.frame(Column = ModelCoeffs[1:4])
starts <- seq(1,length(ModelCoeffs), by = 4)
for(i in 2:(length(ModelCoeffs)/4)){
  tabout <- cbind(tabout, ModelCoeffs[starts[i]:(starts[i]+3)])
...
rownames(tabout) <- c("Intercept", "$p_{Intercept}$", "Slope", "$p_{Slope}$")
Short <- paste("Geo-referenced PFTs and Vegetation Memory", sep="")
Long <- paste("Linear regression coefficients of vegetative height (H) and leaf nitrogen mass (Nmass) against vegetation memory coefficients.", sep="")
kab <- kable(tabout, 
            booktabs = TRUE,
            caption = paste("\\textbf{",Short, " -} ",Long, sep=""),
            caption.short = Short,
...
ModelCoeffs <- c(unlist(IBPFT1)[c(5:8, 13:16)], unlist(IBPFT2)[c(5:8, 13:16)], 
                 unlist(IBPFT3)[c(5:8, 13:16)], unlist(IBPFT4)[c(5:8, 13:16)], 
                 unlist(IBPFT5)[c(5:8, 13:16)], unlist(IBPFT6)[c(5:8, 13:16)])
tabout <- data.frame(Column = ModelCoeffs[1:4])
starts <- seq(1,length(ModelCoeffs), by = 4)
for(i in 2:(length(ModelCoeffs)/4)){
  tabout <- cbind(tabout, ModelCoeffs[starts[i]:(starts[i]+3)])
...
colnames(tabout) <- rep(c("H", "$N_{mass}$"), 6)
rownames(tabout) <- c("Intercept", "$p_{Intercept}$", "Slope", "$p_{Slope}$")
Short <- paste("Mapped species-secific PFT means and Vegetation Memory", sep="")
Long <- paste("Linear regression coefficients of vegetative height (H) and leaf nitrogen mass (Nmass) against vegetation memory coefficients.", sep="")
kab <- kable(tabout, 
            booktabs = TRUE,
            caption = paste("\\textbf{",Short, " -} ",Long, sep=""),
...
```{r IBCOMPAD1, echo = FALSE, fig.width = 17, fig.height = 8, fig.cap="\\textbf{COMPADRE FSC-1 and Vegetation Memory (Iberian Region) -} Linear regression coefficients of COMPADRE FSC-1 and vegetation memory coefficients. \\label{fig:IBCOMPAD1}", fig.scap="COMPADRE FSC-1 and Vegetation Memory (Iberian Region)", cache = TRUE, cache.lazy=FALSE, out.extra='', fig.pos = 'h!'}
...
```{r IBCOMPAD2, echo = FALSE, fig.width = 17, fig.height = 8, fig.cap="\\textbf{COMPADRE FSC-2 and Vegetation Memory (Iberian Region) -} Linear regression coefficients of COMPADRE FSC-2 and vegetation memory coefficients. \\label{fig:IBCOMPAD2}", fig.scap="COMPADRE FSC-2 and Vegetation Memory (Iberian Region)", cache = TRUE, cache.lazy=FALSE, out.extra='', fig.pos = 'h!'}
...
```{r IBCOMPAD5, echo = FALSE, fig.width = 17, fig.height = 8, fig.cap="\\textbf{COMPADRE Reactivity and Vegetation Memory (Iberian Region) -} Linear regression coefficients of COMPADRE Reactivity and vegetation memory coefficients. \\label{fig:IBCOMPAD5}", fig.scap="COMPADRE Reactivity and Vegetation Memory (Iberian Region)", cache = TRUE, cache.lazy=FALSE, out.extra='', fig.pos = 'h!'}
