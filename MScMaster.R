...
#              Regions = list(c("Portugal", "Spain", "France", "Andorra"), "Brazil", "Australia"),
#              RegionFiles = list("Iberian Region", "Caatinga", "Australia"),
#              Extents = list(extent(-10,10,35,52), extent(-50,-34,-23,0), NULL))


Fun_Vegetation(Regions = list(c("Canada")),
               RegionFiles = list("Canada"),
               Extents = list(NULL),
               From = 1982, To = 2015, Lags = 0:24, Cores = 1)
